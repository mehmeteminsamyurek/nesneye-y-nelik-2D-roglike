...
public class Enemy : CellObject //temelde CellObject ama hareket ediyor ve player çarpınca öldürüyor
{
    public int Health = 3;
    ...
    public override bool PlayerWantsToEnter() //düşmana çarpınca yenilme
    {
        GameManager.Instance.ChangeFood(-GameManager.Instance.m_FoodAmount);
    ...
    private void Update()
    {
       ...
       //     GameManager.PlayerController.GameOver();
